...
(
  ...
  se_trigtype int NOT NULL default 0,
  se_trignum int NOT NULL default 0,
...
INSERT INTO %dbpre%special (se_title,se_desc,se_trignum) VALUES('Combo King','15 kills with the Shock Rifle' + char(39) + 's combo',15);
INSERT INTO %dbpre%special (se_title,se_desc,se_trignum) VALUES('Shaftmaster','15 kills with the Link Gun' + char(39) + 's alt fire',15);
...
INSERT INTO %dbpre%special (se_title,se_desc,se_trigtype,se_trignum) VALUES('Telefrag','Gibbing someone with a translocator.',4,1);
...
INSERT INTO %dbpre%special (se_title,se_desc,se_trignum) VALUES('Top Gun','Destroying a flying vehicle using a Raptor' + char(39) + 's missiles.',1);
