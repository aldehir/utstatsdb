...
INSERT INTO %dbpre%config (conf,type,value,name,descr) VALUES('layout','i2','5','Layout','Layout to use: 1=Default ngStats, 2=Smaller fonts, 3=Dark colors/small fonts, 4=Small/Dark/No bold, 5=Modern/Default');
